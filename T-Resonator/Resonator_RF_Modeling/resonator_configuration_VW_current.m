...
% VW sections
cfg.TL(2) = CoaxTransmissionLine(cfg.f, 282e-3,  0.14,   0.195,   epsilon_r,  Constants.conductivity_Cu); % 
cfg.TL(3) = CoaxTransmissionLine(cfg.f, 213e-3,  0.14,   0.230,   epsilon_r,  Constants.conductivity_Cu); % VW
cfg.TL(4) = CoaxTransmissionLine(cfg.f, 266e-3,  0.14,   0.195,   epsilon_r,  Constants.conductivity_Cu); % 

cfg.TL(5) = CoaxTransmissionLine(cfg.f, 1716e-3-266e-3,  0.14,   0.230,   epsilon_r,  Constants.conductivity_Cu); % 
...
% Dans le code d'Arnaud, une section de ligne supplémentaire de 0.016m/ZC2/gamma_copper est
% ajoutée ici entre 7 et 8. Cette section n'est pas décrite dans la documentation D0&D1. 
% Est-ce le bellows ?
...
% affiche les impedances caract calculée des lignes
%disp(['Zc               gamma'])
