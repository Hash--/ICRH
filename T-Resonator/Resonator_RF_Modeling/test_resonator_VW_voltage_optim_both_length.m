...
cfg = resonator_configuration_VW_voltage(f, L_DUT, L_CEA);
...
figure(1)
    ...
    L_VW1 = cfg.TL(7).L+cfg.TL(6).L+cfg.TL(5).L+cfg.TL(4).L;
    L_VW2 = cfg.TL(7).L+cfg.TL(6).L+cfg.TL(5).L+cfg.TL(4).L+cfg.TL(3).L;

    line([L_VW1 L_VW1], [0 60e3], 'Color', 'k')
    line([L_VW2 L_VW2], [0 60e3], 'Color', 'k')
